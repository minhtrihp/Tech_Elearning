...
<div id="newcourses">
      <div>
            ...
            <span class="float-right"><a href="admin/courses/list">Add Course</a></span>
      </div>
      <ul class="list-group">
                      ...
                      ?>
                        ...
                        <a href="" style="text-decoration: none;" class="text-primary">
                          <div class="list-group-item justify-content-between align-items-center m-1" style="height: 370px;  background-color: lightgrey;border-radius: 7px;">
                            <p style="border:1px solid #80808060"><img style="margin-bottom: 0px!important;" width="298px" height="220px" src="upload/khoahoc/{{$khoahoc1['picture']}}"></p>
                            ...
                            <a class="btn btn-primary" style="margin-left: 98px; font-size: 15px;margin-top:10px;font-weight: 600" href="courses/{{$khoahoc1['course_id']}}/{{$khoahoc1['name']}}.html">THAM GIA</a>
